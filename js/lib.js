...
!(function (e) {
          ...
          },
          {
            ...
            value: function (e, t) {
              if (e && void 0 !== e.email) {
                ...
                (e.analyticsV2 = a.default.makeClientFingerPrint()),
                  a.default
    ...
    var s = (function () {
      function e() {
        ...
        !(function (e, t) {
          ...
          (this.cid = i),
          (this.baseAPIEndpoint =
            void 0 !== n ? n : 'https://websales-api.tryemanagecrm.com/api');
      }
      return (
        r(e, [
          {
    ...
    (function (t, i) {
      ...
      (n = function () {
        ...
        function L(e) {
          ...
          if (0 !== t.length) {
            for (
              var n = void 0, r = void 0, o = e._result, a = 0;
              a < t.length;
              a += 3
            )
              (n = t[a]), (r = t[a + i]), n ? U(i, n, r, o) : r(o);
  ...
  function (e, t, i) {
    ...
    var l = (function () {
        ...
        var n,
          r = 'codebase code name archive object width height alt align hspace vspace'
            .split(' ')
            .concat(i);
        try {
          n =
        ...
        var o = {
          ...
          writeAppletTag: function (e, t) {
            ...
            a || (n += '<param name="codebase_lookup" value="false"/>'),
              o && (i += ' code="dummy"'),
              document.write(i + '>\n' + n + '\n</applet>');
          },
          versionCheck: function (t) {
            ...
            if (null != n) {
              for (var r = (t = !1), o = [], a = 1; a < n.length; ++a)
                'string' == typeof n[a] && '' != n[a] && ((o[i] = n[a]), i++);
              for (
                '+' == o[o.length - 1]
                  ? ((r = !0), (t = !1), o.length--)
                  : '*' == o[o.length - 1]
          ...
          compareVersionToPattern: function (e, t, i, n) {
            ...
            if (null != r) {
              ...
              for (var a = 1; a < r.length; ++a)
                'string' == typeof r[a] && '' != r[a] && ((e[o] = r[a]), o++);
              ...
              for (a = 0; a < r; ++a) if (e[a] != t[a]) return !1;
    ...
    function c(e, t) {
      var i, n, r, o, a;
      for (i = 3 & e.length, n = e.length - i, r = t, a = 0; a < n; )
        (o =
          (255 & e.charCodeAt(a)) |
    ...
    var d = (function () {
      function e() {
        if (!x) {
          try {
            (e = P.getElementsByTagName('body')[0].appendChild(
      ...
      function i(e) {
        ...
        else if (void 0 !== P.addEventListener)
          P.addEventListener('load', e, !1);
        else if (void 0 !== S.attachEvent)
          !(function (e, t, i) {
                  ...
                  if (I[t].expressInstall && o()) {
                    ...
                    for (
                      ...
                      'movie' != u[p].getAttribute('name').toLowerCase() &&
                        (c[u[p].getAttribute('name')] = u[p].getAttribute(
                          'value'
                        ));
                    a(l, c, i, n);
                  } else s(u), n && n(l);
      ...
      function a(e, t, i, n) {
        ...
        r &&
          ...
          B.ie &&
            ...
            4 != r.readyState &&
            ((i += 'SWFObjectNew'),
            (n = P.createElement('div')).setAttribute('id', i),
      ...
      function u(e, t, i) {
        ...
        if (r)
          if ((void 0 === e.id && (e.id = i), B.ie && B.win)) {
            ...
            for (var l in ((s = P.createElement('object')).setAttribute(
              'type',
            ...
            e))
              e[l] != Object.prototype[l] &&
                ('styleclass' == l.toLowerCase()
                  ? s.setAttribute('class', e[l])
                  : 'classid' != l.toLowerCase() && s.setAttribute(l, e[l]));
            for (a in t)
              t[a] != Object.prototype[a] &&
                ...
                (o = a),
                (l = t[a]),
                (i = P.createElement('param')).setAttribute('name', o),
      ...
      function p(e, t, i, n) {
        if (!B.ie || !B.mac) {
          ...
          r &&
            ...
            n && (E = A = null),
            (A && E == i) ||
              ((n = P.createElement('style')).setAttribute('type', 'text/css'),
              n.setAttribute('media', i),
              (A = r.appendChild(n)),
              B.ie &&
                B.win &&
                void 0 !== P.styleSheets &&
                0 < P.styleSheets.length &&
                (A = P.styleSheets[P.styleSheets.length - 1]),
              (E = i)),
            B.ie && B.win
              ? A && 'object' == typeof A.addRule && A.addRule(e, t)
              : A &&
                void 0 !== P.createTextNode &&
                A.appendChild(P.createTextNode(e + ' {' + t + '}')));
        }
      }
      function m(e, t) {
        if (N) {
      ...
      var v,
        ...
        B = (function () {
          var e =
              void 0 !== P.getElementById &&
              void 0 !== P.getElementsByTagName &&
          ...
          if (
            ...
            !(a = C.plugins['Shockwave Flash'].description) ||
              ...
              (o[2] = /[a-zA-Z]/.test(a)
                ...
                : 0));
          else if (void 0 !== S.ActiveXObject)
            try {
      ...
      return (
        B.w3 &&
          (((void 0 !== P.readyState && 'complete' == P.readyState) ||
            (void 0 === P.readyState &&
              (P.getElementsByTagName('body')[0] || P.body))) &&
            e(),
          x ||
            (void 0 !== P.addEventListener &&
              P.addEventListener('DOMContentLoaded', e, !1),
            B.ie &&
              B.win &&
              (P.attachEvent('onreadystatechange', function () {
                'complete' == P.readyState &&
                  (P.detachEvent('onreadystatechange', arguments.callee), e());
              }),
              S == top &&
                (function () {
                  if (!x) {
    ...
    !(function (i, n) {
      var r = {
        ...
        o = function () {
          for (
            var e, t, i, r, o, a, s, l = 0, u = arguments;
            l < u.length && !a;
